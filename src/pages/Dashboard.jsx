...
export default function Dashboard({ showToast }) {
    ...
    const { students, lessons, setStudents, setLessons, cash, setCash, institutions, activeInstitution, switchInstitution, loading, updateActiveInstitution, transactions } = useInstitution();
    ...
    const handleCompleteLesson = (topic, homework, paymentMethod) => {
        ...
        if (paymentMethod === 'balance') {
            ...
            // Update Active Institution Atomically
            updateActiveInstitution({
                cash: cash + student.feePerLesson,
